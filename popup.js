...
- 「膿皮症」「農皮症」→「膿皮症」
- 「痂皮」「カヒ」→「痂皮」
- 「低酵素」「定酵素」「ていこうそ」→「天疱瘡」：皮膚がボロボロ・自己免疫の話題 → 天疱瘡

## 薬剤
- 「デモリューション」「でもリューション」→「レボリューション」：駆虫・予防薬の話題 → レボリューション（セラメクチン）
- 「フンデロイド」「フンステロイド」→「ステロイド」との併用の話題では文脈に応じて判断
- 「クラミプラミン」「クラミン」→「クロミプラミン」：行動修正薬・三環系抗うつ薬の話題 → クロミプラミン
...
- 「胃腸うっ滞」「胃腸鬱体」→「胃腸うっ滞」`;
      ...
      - 「〜した」「〜を実施」と書く場合、会話中で実際にその行為が行われたことが明確に述べられている場合のみ。「〜が必要」「〜しないと」等の発言は将来の計画であり、実施した事実ではない。
      - [O]には実際に実施された検査・所見のみ。「〜が必要」等の会話中の発言を所見として記載しない。
